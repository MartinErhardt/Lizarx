/*  <src-path>/src/kernel/drv/keyboard/keyboard.c is a source file of Lizarx an unixoid Operating System, which is licensed under GPLv3 look at <src-path>/LICENSE for more info
