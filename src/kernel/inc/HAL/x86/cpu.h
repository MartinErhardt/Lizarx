/*  <src-path>/src/kernel/inc/HAL/x86/cpu.h is a source file of Lizarx an unixoid Operating System, which is licensed under GPLv3 look at <src-path>/LICENSE for more info
...
#define INIT_STATE(STATE)		STATE->kernel_mode=0; \
					STATE->eax=0x0; \
					STATE->ebx=0x0; \
					STATE->ecx=0x0; \
					STATE->edx=0x0; \
