/*   <src-path>/src/kernel/inc/HAL/x86/asm_inline.h is a source file of Lizarx an unixoid Operating System, which is licensed under GPLv2 look at <src-path>/COPYRIGHT.txt for more info
 * 
 ...
 */
#ifndef X86_ASMINLINE_H
#define X86_ASMINLINE_H
