/*  <src-path>/src/usr/ld_a/elf.h is a source file of Lizarx an unixoid Operating System, which is licensed under GPLv3 look at <src-path>/LICENSE for more info
...
#endif
#ifdef ARCH_X86_64
	#define ELF_REL_BIND(i)			((i)>>32)
	#define ELF_REL_TYPE(i)			((i) &0xffffffffL)
	#define ELF_REL_INFO(s, t)		(((s) << 32) + ((t) & 0xffffffffL))
#endif
/*
