 /*   <src-path>/src/usr/Daemons/hlib/list.c is a source file of Lizarx an unixoid Operating System, which is licensed under GPLv2 look at <src-path>/COPYRIGHT.txt for more info
 * 
...
void * alist_get_by_entry8(alist_t * list, unsigned long off, uint8_t val)
{
	int i;
	do{
		for(i=0;i<ENTRYS_PER_ARRAY;i++)
